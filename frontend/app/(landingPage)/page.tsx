    ...
    return (
        <div className="flex flex-col items-center justify-center">
            <div className="flex items-center justify-between space-x-10 min-h-screen px-14">
                <div className="w-2/5">
                    <h2 className="font-bold text-4xl text-primary">Build Work Experience Through Skills Challenges Program</h2>
            ...
            <div className="flex flex-col items-center w-full px-14 py-14">
                <div className="bg-primary flex justify-evenly items-center rounded-2xl text-white py-14 w-full">
                    <div>
            ...
            <div className="flex flex-col justify-center items-center gap-14 w-full px-14 py-14">
                <div className="flex flex-col items-center">
                    <h2 className="w-8/12 font-bold text-3xl text-center">
            ...
            <div className="flex flex-col items-center gap-14 w-full px-14 py-14">
                <div className="flex flex-col items-center">
                    <h2 className="w-8/12 font-bold text-3xl text-center">
                        Explore Challenges & Hackathons
                    </h2>
                    <p className="mt-4 w-7/12 text-sm text-center text-gray-600">
            ...
            <div className="bg-[#F9FAFB] flex flex-col items-center gap-14 w-full px-14 py-14">
                <div className="flex flex-col items-center">
                    <h2 className="w-8/12 font-bold text-3xl text-center">
            ...
            <div className="flex flex-col items-center gap-14 w-full py-14">
                <div className="w-full px-14">
                    <h2 className="w-5/12 font-bold text-3xl">
                        Users are in Love with Skills Challenges Program
                    </h2>
                    <p className="mt-4 w-5/12 text-sm text-gray-600">
            ...
            <div className="bg-[#F9FAFB] flex flex-col items-center gap-14 w-full py-14 px-14">
                <div className="flex justify-center items-center">
                    <h2 className="font-bold text-3xl text-center">
                        How to Get Started
                    </h2>
                </div>
                <div className="w-10/12 grid grid-cols-2 grid-rows-6 gap-5">
                    <div className="bg-white flex flex-col justify-between border rounded-md overflow-hidden row-span-3 col-start-1">
                    ...
                    <div className="bg-white border rounded-md row-start-1 row-end-3 col-start-2">
                        <div className="space-y-4 p-4">
                    ...
                    <div className="bg-white border rounded-md row-start-3 row-end-5 col-start-2">
                        <div className="space-y-4 p-4">
                    ...
                    <div className="bg-white border rounded-md row-span-2 col-start-2">
                        <div className="space-y-4 p-4">
            ...
            <div className="flex flex-col items-center gap-14 w-full py-14 px-14">
                <div className="bg-primary flex justify-between items-center w-full py-10 px-14 rounded-2xl">
                    <Image
                        src="/image-9.png"
                        alt="image-1"
                        ...
                        width={1000}
                    />
                    <Card className="border-none shadow-none w-1/2 h-fit text-white">
                        <CardHeader>
                            <CardTitle>
